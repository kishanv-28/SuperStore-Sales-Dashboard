...
- **Power BI Features Used**:  
  - KPI Cards  
  - DAX Queries {Aggregation of sales and Order Date} _**(Salesforecast = SUMMARIZE('SuperStore_Sales_Dataset csv','SuperStore_Sales_Dataset csv'[Order Date],"Total Sales",SUM('SuperStore_Sales_Dataset csv'[Sales])) )**_
